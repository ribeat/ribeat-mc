...
//            button.isEnabled = true
    ...
    override func viewDidLoad() {
        ...
        addOrder()
        self.updateInterval = Timer.scheduledTimer(timeInterval: 5, target: self, selector: #selector(runTimedCode), userInfo: nil, repeats: true)
